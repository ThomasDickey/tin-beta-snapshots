...
struct opttxt txt_art_marked_fresh = {
	"Enter character to indicate fresh articles. <CR> sets, <ESC> cancels.",
	"Character to show fresh articles   : ",
	"# Character used to show that an art is fresh (default 'o')\n"
};
...
struct opttxt txt_fresh_time = {
	"Enter number of days article is considered fresh. <CR> sets.",
	"Article freshness time limit       : ",
	"# Number of days in which article is considered fresh, (0=off)\n"
};
